...
const en = {
  ...
  detail: {
    ...
    demoDescription:
      "Load the interactive project when you are ready, or download the SB3 file directly.",
...
const zhCN: Messages = {
  ...
  detail: {
    ...
    references: "参考资料",
    demo: "示例项目",
    demoDescription: "需要时再加载交互式项目，也可以直接下载 SB3 文件。",
    loadDemo: "加载交互演示",
...
const zhTW: Messages = {
  ...
  detail: {
    ...
    references: "參考資料",
    demo: "範例專案",
    demoDescription: "需要時再載入互動式專案，也可以直接下載 SB3 檔案。",
    loadDemo: "載入互動展示",
